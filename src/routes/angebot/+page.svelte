...
<center>
  <section class="flex flex-col justify-center items-center gap-8 sm:w-7/12 w-9/12 transition-all duration-500">
    ...
    <p class="w-full text-start ml-10">
      ...
      Ich biete <b>Einzelberatung</b> an für <b>Erwachsene</b> und <b>junge Erwachsene</b>, die immer bei ähnlichen Problemen anstehen, in einer schwierigen Situation stecken oder sich weiterentwickeln und besser kennenlernen möchten.<br><br>
